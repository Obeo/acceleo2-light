/*****************************************************************************************
 * Copyright (c) 2007, 2009 THALES CORPORATE SERVICE
 * All rights reserved.
 *
 * Contributors:
 *      Yann Mortier      (Obeo) <yann.mortier@obeo.fr>      - Initial API and implementation 
 *****************************************************************************************/

package fr.obeo.dsl.common.acceleo;
...
import fr.obeo.dsl.common.acceleo.business.internal.interpreter.IAcceleoInterpreterMessages;
...
public class AcceleoInterpreterPlugin extends Plugin {
    ...
    /** The plug-in ID . */
    public static final String PLUGIN_ID = "fr.obeo.dsl.common.acceleo";
