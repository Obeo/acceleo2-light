...
public class ENodeServices {
	 ...
	 * @param node
	 *            is the current node
	 *            <li>isEObject() : return 1</li>
	 *            <li> isList() : return getList().size()</li>
	 *            <li>isString() : return getString().length()</li>
	 *            <li>isBoolean() : return 1</li>
	 *            <li>isInt() : return 1</li>
	 *            <li>isNull() : return 0</li>
	 * @return value size
	 */
